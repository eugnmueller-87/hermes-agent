...
class RedisStore:
    def __init__(self):
        ...
        if vector_url and vector_token:
            try:
                ...
                logging.info("[Hermes] Vector index connected")
            except Exception as e:
                logging.warning(f"[Hermes] Vector index init failed: {e}")
    ...
    def store_item(self, item: dict):
        ...
        if self.index:
            try:
                ...
                logging.warning(f"[Hermes] Vector upsert failed for {item['id']}: {e}")
    ...
    def semantic_search(self, query: str, limit: int = 10) -> list[dict]:
        ...
        try:
            ...
            logging.warning(f"[Hermes] Vector search failed: {e}")
            return []
    ...
    def flush(self):
        ...
        if self.index:
            try:
                ...
                logging.warning(f"[Hermes] Vector reset failed: {e}")
